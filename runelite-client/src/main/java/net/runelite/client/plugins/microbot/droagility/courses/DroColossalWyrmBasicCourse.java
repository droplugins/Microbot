...
public class DroColossalWyrmBasicCourse implements DroAgilityCourseHandler
{
	@Override
	...
	{
		return List.of(
			new DroAgilityObstacleModel(ObjectID.VARLAMORE_WYRM_AGILITY_START_LADDER_TRIGGER),
			new DroAgilityObstacleModel(ObjectID.VARLAMORE_WYRM_AGILITY_BALANCE_1_TRIGGER, -1, 2926, Operation.GREATER, Operation.GREATER_EQUAL),
			new DroAgilityObstacleModel(ObjectID.VARLAMORE_WYRM_AGILITY_BASIC_BALANCE_1_TRIGGER, 1647, -1, Operation.GREATER_EQUAL, Operation.GREATER_EQUAL),
			new DroAgilityObstacleModel(ObjectID.VARLAMORE_WYRM_AGILITY_BASIC_MONKEYBARS_1_TRIGGER, 1635, -1, Operation.LESS_EQUAL, Operation.GREATER_EQUAL),
			new DroAgilityObstacleModel(ObjectID.VARLAMORE_WYRM_AGILITY_BASIC_LADDER_1_TRIGGER, 1628, -1, Operation.LESS_EQUAL, Operation.GREATER),
			new DroAgilityObstacleModel(ObjectID.VARLAMORE_WYRM_AGILITY_END_ZIPLINE_TRIGGER)
		);
	}
