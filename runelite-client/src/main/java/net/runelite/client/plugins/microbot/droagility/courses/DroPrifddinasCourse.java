...
@Slf4j
public class DroPrifddinasCourse implements DroAgilityCourseHandler
{
	...
	{
		return List.of(
			new DroAgilityObstacleModel(ObjectID.PRIF_AGILITY_START_LADDER, 3254, -1, Operation.LESS_EQUAL, Operation.GREATER), // before 3254,6108, after 3255,6109
			new DroAgilityObstacleModel(ObjectID.PRIF_AGILITY_TIGHTROPE_START1, 3258, -1, Operation.LESS_EQUAL, Operation.GREATER), // before 3255,6109 , after 3272, 6105
			new DroAgilityObstacleModel(ObjectID.PRIF_AGILITY_CHIMNEY_JUMP, -1, 6106, Operation.GREATER, Operation.LESS_EQUAL), // before 3273,6105 , after 3269,6112
			new DroAgilityObstacleModel(ObjectID.PRIF_AGILITY_ROOF_JUMP, -1, 6115, Operation.GREATER, Operation.LESS_EQUAL), // before 3269,6112 , after 3269,6117
			new DroAgilityObstacleModel(ObjectID.PRIF_AGILITY_DARK_HOLE_ACTIVE, 3269	, 6117, Operation.EQUAL, Operation.LESS_EQUAL), // before 3269,6117  , after 2269,3389
			new DroAgilityObstacleModel(ObjectID.PRIF_AGILITY_TREE_LADDER_LONG, -1, 3392, Operation.GREATER, Operation.LESS_EQUAL), // before 2269,3389 , after 2269,3393
			new DroAgilityObstacleModel(ObjectID.PRIF_AGILITY_ROPE_BRIDGE1, 2265, -1, Operation.GREATER_EQUAL, Operation.GREATER), // before 2269,3393 , after 2257,3390
			new DroAgilityObstacleModel(ObjectID.PRIF_AGILITY_TIGHTROPE1, 2254, -1, Operation.GREATER_EQUAL, Operation.GREATER), // before 2257,3390, after 2247,3397
			new DroAgilityObstacleModel(ObjectID.PRIF_AGILITY_TREE_LADDER_SHORT, -1, 6140, Operation.GREATER, Operation.GREATER), // if fail TIGHTROPE_36234 , before 3274,6147, after
			new DroAgilityObstacleModel(ObjectID.PRIF_AGILITY_ROPE_BRIDGE2, -1, 3398, Operation.GREATER, Operation.LESS_EQUAL), // before 2247,3397, after 2246,3406
			new DroAgilityObstacleModel(ObjectID.PRIF_AGILITY_TIGHTROPE2, -1, 3409, Operation.GREATER, Operation.LESS_EQUAL), // before 2246,3406, after 2250,3416
			new DroAgilityObstacleModel(ObjectID.PRIF_AGILITY_TIGHTROPE3, -1, 3419, Operation.GREATER, Operation.LESS_EQUAL), // before 2250,3416 , after 2260 3425 //2253,3417 portal spawn
			new DroAgilityObstacleModel(ObjectID.PRIF_AGILITY_DARK_HOLE_END, -1, 3431, Operation.GREATER, Operation.LESS_EQUAL) // before 2260,3425 , after 3240,6109
		);
	}
	...
	public TileObject getCurrentObstacle()
	{
		...
		return DroAgilityCourseHandler.super.getCurrentObstacle();
	}
	...
	public boolean handleWalkToStart(WorldPoint playerWorldLocation)
	{
		...
		log.debug("DroPrifddinasCourse.handleWalkToStart() returning false");
		return false;
	}
}
