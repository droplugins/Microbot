...
public class DroColossalWyrmAdvancedCourse implements DroAgilityCourseHandler
{
	@Override
	...
	public List<DroAgilityObstacleModel> getObstacles()
	{
		return List.of(
			...
			new DroAgilityObstacleModel(ObjectID.VARLAMORE_WYRM_AGILITY_ADVANCED_LADDER_1_TRIGGER, -1, 2911, Operation.GREATER, Operation.LESS_EQUAL),
			new DroAgilityObstacleModel(ObjectID.VARLAMORE_WYRM_AGILITY_ADVANCED_JUMP_1_TRIGGER, 1647, -1, Operation.GREATER_EQUAL, Operation.GREATER_EQUAL),
			new DroAgilityObstacleModel(ObjectID.VARLAMORE_WYRM_AGILITY_ADVANCED_BALANCE_1_TRIGGER),
