...
import net.runelite.client.plugins.microbot.droagility.courses.DroPyramidObstacleData.ObstacleArea;
...
@Slf4j
public class DroPyramidCourse implements DroAgilityCourseHandler {
    ...
    private final DroPyramidState state = new DroPyramidState();
    private long lastStartWalkFailureAt = 0;
    
    
    // Obstacle areas are now defined in DroPyramidObstacleData for better maintainability
    private static final List<ObstacleArea> OBSTACLE_AREAS = DroPyramidObstacleData.OBSTACLE_AREAS;
    ...
    public List<DroAgilityObstacleModel> getObstacles() {
        ...
        return Arrays.asList(
            new DroAgilityObstacleModel(10857), // Stairs
            new DroAgilityObstacleModel(10865), // Low wall
            new DroAgilityObstacleModel(10860), // Ledge
            new DroAgilityObstacleModel(10867), // Plank (main object)
            new DroAgilityObstacleModel(10868), // Plank end (clickable)
            new DroAgilityObstacleModel(10859), // Gap jump
            new DroAgilityObstacleModel(10882), // Gap (floor 1)
            new DroAgilityObstacleModel(10886), // Ledge 3
            new DroAgilityObstacleModel(10884), // Gap (floor 2)
            new DroAgilityObstacleModel(10861), // Gap
            new DroAgilityObstacleModel(10888), // Ledge 2
            new DroAgilityObstacleModel(10851), // Climbing rocks
            new DroAgilityObstacleModel(10855)  // Doorway
        );
    }
