...
public class DeadFallTrapHunterOverlay extends OverlayPanel {
    ...
    @Inject
    public DeadFallTrapHunterOverlay(Client client, DroHunterConfig config, DeadFallTrapHunterPlugin plugin, DeadFallTrapHunterScript script) {
        super(plugin);
        this.client = client;
        this.config = config;
        this.plugin = plugin;
