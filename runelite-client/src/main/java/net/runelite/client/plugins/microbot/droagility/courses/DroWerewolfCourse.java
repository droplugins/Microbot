...
public class DroWerewolfCourse implements DroAgilityCourseHandler {
    ...
    public List<DroAgilityObstacleModel> getObstacles() {
        return List.of(
                new DroAgilityObstacleModel(ObjectID.WEREWOLF_STEPING_STONE, 3538, 9875, Operation.GREATER_EQUAL, Operation.LESS),
                new DroAgilityObstacleModel(ObjectID.WEREWOLF_STEPING_STONE, 3538, 9877, Operation.EQUAL, Operation.LESS),
                new DroAgilityObstacleModel(ObjectID.WEREWOLF_STEPING_STONE, 3540, 9877, Operation.LESS, Operation.EQUAL),
                new DroAgilityObstacleModel(ObjectID.WEREWOLF_STEPING_STONE, 3540, 9879, Operation.EQUAL, Operation.LESS),
                new DroAgilityObstacleModel(ObjectID.WEREWOLF_STEPING_STONE, 3540, 9881, Operation.EQUAL, Operation.LESS),
                new DroAgilityObstacleModel(ObjectID.WEREWOLF_HURDLE_MID, 3540, 9893, Operation.EQUAL, Operation.LESS),
                new DroAgilityObstacleModel(ObjectID.WEREWOLF_HURDLE_MID, 3540, 9896, Operation.EQUAL, Operation.LESS),
                new DroAgilityObstacleModel(ObjectID.WEREWOLF_HURDLE_MID, 3540, 9899, Operation.EQUAL, Operation.LESS),
                new DroAgilityObstacleModel(ObjectID.WAA_PIPE, 3540, 9905, Operation.EQUAL, Operation.LESS),
                new DroAgilityObstacleModel(ObjectID.WEREWOLF_SKULL_CLIMB_1, 3532, 9909, Operation.GREATER, Operation.GREATER),
                new DroAgilityObstacleModel(ObjectID.WEREWOLF_SLIDE_CENTER, 3528, 9909, Operation.GREATER_EQUAL, Operation.GREATER_EQUAL),
                new DroAgilityObstacleModel(ObjectID.WEREWOLF_SLIDE_CENTER, 3538, 9898, Operation.LESS, Operation.LESS) // Helper step when we fail slide
        );
    }
    ...
    DroAgilityObstacleModel matchingObstacle;
    ...
    public TileObject getCurrentObstacle() {
        ...
        List<DroAgilityObstacleModel> matchingObstacles = getObstacles().stream()
        ...
        List<Integer> objectIds = matchingObstacles.stream()
                .map(DroAgilityObstacleModel::getObjectID)
                .collect(Collectors.toList());
