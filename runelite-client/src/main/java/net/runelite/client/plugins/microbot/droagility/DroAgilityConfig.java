...
@ConfigInformation("Enable the plugin near the start of your selected agility course. <br />" +
	...
	"</ul>")
public interface DroAgilityConfig extends Config
{
	...
	default DroAgilityCourse agilityCourse()
	{
		return DroAgilityCourse.CANIFIS_ROOFTOP_COURSE;
	}
	...
	default DroAgilityFoodOption bankFood()
	{
		return DroAgilityFoodOption.NONE;
	}
	...
	default DroAgilityPotionOption bankPotion()
	{
		return DroAgilityPotionOption.NONE;
	}
	...
	default DroAgilityEquipmentOption bankEquipment()
	{
		return DroAgilityEquipmentOption.NONE;
	}
